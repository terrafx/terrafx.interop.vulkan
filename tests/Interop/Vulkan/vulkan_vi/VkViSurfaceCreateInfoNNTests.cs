...
// Ported from include/vulkan/vulkan_vi.h in the KhronosGroup/Vulkan-Headers repository for tag v1.2.170
...
namespace TerraFX.Interop.UnitTests
{
    ...
    public static unsafe class VkViSurfaceCreateInfoNNTests
    {

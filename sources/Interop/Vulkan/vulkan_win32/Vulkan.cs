...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("vulkan", EntryPoint = "vkCreateWin32SurfaceKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetPhysicalDeviceWin32PresentationSupportKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetMemoryWin32HandleKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetMemoryWin32HandlePropertiesKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkImportSemaphoreWin32HandleKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetSemaphoreWin32HandleKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkImportFenceWin32HandleKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetFenceWin32HandleKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetMemoryWin32HandleNV", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetPhysicalDeviceSurfacePresentModes2EXT", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkAcquireFullScreenExclusiveModeEXT", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkReleaseFullScreenExclusiveModeEXT", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetDeviceGroupSurfacePresentModes2EXT", ExactSpelling = true)]

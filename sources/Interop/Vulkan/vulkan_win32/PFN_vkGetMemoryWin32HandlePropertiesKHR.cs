...
namespace TerraFX.Interop
{
    ...
    public unsafe delegate VkResult PFN_vkGetMemoryWin32HandlePropertiesKHR([NativeTypeName("VkDevice")] IntPtr device, VkExternalMemoryHandleTypeFlagBits handleType, [NativeTypeName("HANDLE")] IntPtr handle, [NativeTypeName("VkMemoryWin32HandlePropertiesKHR *")] VkMemoryWin32HandlePropertiesKHR* pMemoryWin32HandleProperties);
}

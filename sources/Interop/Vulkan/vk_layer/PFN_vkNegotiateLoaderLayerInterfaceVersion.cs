...
namespace TerraFX.Interop
{
    ...
    public unsafe delegate VkResult PFN_vkNegotiateLoaderLayerInterfaceVersion([NativeTypeName("VkNegotiateLayerInterface *")] VkNegotiateLayerInterface* pVersionStruct);
}

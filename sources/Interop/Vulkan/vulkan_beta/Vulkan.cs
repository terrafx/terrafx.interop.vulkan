...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("vulkan", EntryPoint = "vkCreateDeferredOperationKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkDestroyDeferredOperationKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetDeferredOperationMaxConcurrencyKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetDeferredOperationResultKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkDeferredOperationJoinKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCreateAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetAccelerationStructureMemoryRequirementsKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdBuildAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdBuildAccelerationStructureIndirectKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkBuildAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCopyAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCopyAccelerationStructureToMemoryKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCopyMemoryToAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkWriteAccelerationStructuresPropertiesKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdCopyAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdCopyAccelerationStructureToMemoryKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdCopyMemoryToAccelerationStructureKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdTraceRaysKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCreateRayTracingPipelinesKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetAccelerationStructureDeviceAddressKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetRayTracingCaptureReplayShaderGroupHandlesKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkCmdTraceRaysIndirectKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", EntryPoint = "vkGetDeviceAccelerationStructureCompatibilityKHR", ExactSpelling = true)]

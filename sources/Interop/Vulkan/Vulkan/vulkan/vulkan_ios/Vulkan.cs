...
namespace TerraFX.Interop.Vulkan
{
    public static unsafe partial class Vulkan
    {
        ...
        public static extern VkResult vkCreateIOSSurfaceMVK(VkInstance instance, [NativeTypeName("const VkIOSSurfaceCreateInfoMVK *")] VkIOSSurfaceCreateInfoMVK* pCreateInfo, [NativeTypeName("const VkAllocationCallbacks *")] VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface);

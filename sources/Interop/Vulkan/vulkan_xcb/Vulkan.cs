...
namespace TerraFX.Interop
{
    ...
    {
        [DllImport("vulkan", CallingConvention = CallingConvention.Winapi, EntryPoint = "vkCreateXcbSurfaceKHR", ExactSpelling = true)]
        ...
        [DllImport("vulkan", CallingConvention = CallingConvention.Winapi, EntryPoint = "vkGetPhysicalDeviceXcbPresentationSupportKHR", ExactSpelling = true)]

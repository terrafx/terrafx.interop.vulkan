...
{
    public unsafe partial struct VkInstance : IComparable, IComparable<VkInstance>, IEquatable<VkInstance>, IFormattable
    {
        ...
        public static explicit operator VkInstance(byte value) => new VkInstance((void*)(value));

        public static explicit operator byte(VkInstance value) => (byte)(value.Value);

        public static explicit operator VkInstance(short value) => new VkInstance((void*)(value));

        public static explicit operator short(VkInstance value) => (short)(value.Value);

        public static explicit operator VkInstance(int value) => new VkInstance((void*)(value));

        public static explicit operator int(VkInstance value) => (int)(value.Value);

        public static explicit operator VkInstance(long value) => new VkInstance((void*)(value));

        public static explicit operator long(VkInstance value) => (long)(value.Value);

        public static explicit operator VkInstance(nint value) => new VkInstance((void*)(value));

        public static implicit operator nint(VkInstance value) => (nint)(value.Value);

        public static explicit operator VkInstance(sbyte value) => new VkInstance((void*)(value));

        public static explicit operator sbyte(VkInstance value) => (sbyte)(value.Value);

        public static explicit operator VkInstance(ushort value) => new VkInstance((void*)(value));

        public static explicit operator ushort(VkInstance value) => (ushort)(value.Value);

        public static explicit operator VkInstance(uint value) => new VkInstance((void*)(value));

        public static explicit operator uint(VkInstance value) => (uint)(value.Value);

        public static explicit operator VkInstance(ulong value) => new VkInstance((void*)(value));

        public static explicit operator ulong(VkInstance value) => (ulong)(value.Value);

        public static explicit operator VkInstance(nuint value) => new VkInstance((void*)(value));

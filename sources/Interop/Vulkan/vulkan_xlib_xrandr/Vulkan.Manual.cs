...
// Ported from include/vulkan/vulkan_xlib_xrandr.h in the KhronosGroup/Vulkan-Headers repository for tag v1.2.135
...
namespace TerraFX.Interop
{
    ...
    {
        public const uint VK_EXT_acquire_xlib_display = 1;
